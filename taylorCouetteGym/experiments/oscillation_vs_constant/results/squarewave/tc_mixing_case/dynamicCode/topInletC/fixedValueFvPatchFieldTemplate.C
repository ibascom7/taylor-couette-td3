...
// dynamicCode:
// SHA1 = 9b34c300baff445d5a8043e8d43d39acf41f42e4
//
// unique function name that can be checked if the correct library version
// has been loaded
extern "C" void topInletC_9b34c300baff445d5a8043e8d43d39acf41f42e4(bool load)
{
    if (load)
    {
...
//{{{ begin code
    #line 35 "/project/mwang/ibascom/taylor-couette-td3/taylorCouetteGym/experiments/oscillation_vs_constant/paraview/squarewave/tc_mixing_case/0/C/boundaryField/top"
