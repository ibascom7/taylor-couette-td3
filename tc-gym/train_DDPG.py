"""Train a DDPG agent on TaylorCouetteMixingEnv with stable-baselines3.

Run from the repo root without installing tc_gym:
    python3 tc-gym/train_DDPG.py [--case-path PATH] [--total-timesteps N] ...

Artifacts (under --save-dir, default: runs/ddpg):
    - checkpoints/ddpg_<n>_steps.zip
    - ddpg_final.zip
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--save-dir", type=str, default="runs/ddpg")
...
def main() -> None:
    ...
    final_path = save_dir / "ddpg_final"
